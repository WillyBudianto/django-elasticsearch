...
class Author(MPTTModel):
    """
    Author table implimented with MPTT
    """
    ...
    slug = models.SlugField(
        ...
        unique=False,
        blank=False,
        verbose_name=_("author safe URL"),
        help_text=_(
            "format: required, letters, numbers, underscore, or hyphens"
        ),
    )
...
class Article(models.Model):
    ...
    url = models.URLField(
        ...
        blank=False,
        verbose_name=_("product name"),
        help_text=_("format: required, letters, number, underscores or hypens"),
    )
    author = TreeManyToManyField(Author)
    categories = TreeManyToManyField(Categories)
    is_premium = models.BooleanField(
        unique=False,
        null=False,
        blank=False,
        default=True,
        verbose_name=_("Article premium"),
        help_text=_("format: true=article premium"),
    )
    date = models.DateTimeField(
        auto_now_add=True,
        editable=False,
        verbose_name=_("date article created"),
